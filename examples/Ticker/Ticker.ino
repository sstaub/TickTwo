...
TickTwo timer1(printMessage, 0, 1);
TickTwo timer2(printCounter, 1000, 0, MILLIS);
TickTwo timer3(printCountdown, 1000, 5);
TickTwo timer4(blink, 500);
TickTwo timer5(printCountUS, 100, 0, MICROS_MICROS);
